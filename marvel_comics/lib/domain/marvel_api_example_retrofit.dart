...
import 'package:marvel_comics/domain/data/marvel_comics_repository_retrofit.dart';
...
Future<MarvelPaginatedList<MarvelComic>> getComics() async {
  ...
  final comicsApi = MarvelComicsApiRetrofit(dio);
  final comicsRepository = MarvelComicsRepositoryRetrofit(comicsApi);
